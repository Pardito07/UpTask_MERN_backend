...
const obtenerProyecto = async (req, res) => {
    ...
    if( proyecto.creador.toString() !== req.usuario._id.toString() && !proyecto.colaboradores.some( colabolador => colabolador._id.toString() === req.usuario._id.toString() ) ){
...
const agregarColaborador = async (req, res) => {
    ...
    if(usuario._id.toString() === req.usuario._id.toString()){
        const error = new Error('No puedes agregarte como colaborador de este proyecto');
        return res.status(404).json({ msg: error.message })
    }
